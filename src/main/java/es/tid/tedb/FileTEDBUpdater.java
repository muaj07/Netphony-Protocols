...
public class FileTEDBUpdater {
	...
	public static Hashtable<String,TEDB> readMultipleDomainSimpleNetworks(String fileName, String layer, boolean allDomains, int lambdaIni, int lambdaEnd, boolean isSSONnetwork, String ID, ReaderParamsEnv envfile) {
		Logger log = LoggerFactory.getLogger("BGP4Peer");
		Object router_id_addr = null;
		Object s_router_id_addr = null;
		Object d_router_id_addr = null;
			...
			for (int j = 0; j < nodes_domains.getLength(); j++) {
				...
				if (readNetwork){
					...
					for (int i = 0; i < itResourcesElement.getLength(); i++) {
						...
						String itResourcesControllerIT = "http://" +envfile.getIdentifier() +":8088/escape/";
