...
public class UpdateDispatcher {
	...
	public UpdateDispatcher(MultiDomainTEDB multiTedb, Hashtable<String, TEDB> intraTEDBs, Hashtable<DomainUpdateTime, Long> domainUpdate, Hashtable<IntraDomainLinkUpdateTime, Long> intraDomainLinkUpdate, Hashtable<InterDomainLinkUpdateTime, Long> interDomainLinkUpdate, Hashtable<NodeITinfoUpdateTime, Long> nodeITinfoUpdate, Hashtable<NodeinfoUpdateTime, Long> nodeinfoUpdate, Hashtable<MDPCEinfoUpdateTime, Long> MDPCEinfoUpdate, LinkedList<CMS_Domain_Msgs> domainPost, BGP4Parameters params){


		//log=LoggerFactory.getLogger("BGP4Server");
		this.updateList=new LinkedBlockingQueue<BGP4Update>();
		this.upt=new UpdateProccesorThread(updateList, multiTedb,intraTEDBs,intraDomainLinkUpdate,interDomainLinkUpdate,nodeITinfoUpdate,nodeinfoUpdate,MDPCEinfoUpdate,domainUpdate,domainPost);
		upt.start();
	...
	public void UpdateMsgQueue(Inet4Address remotePeerIP) {
		...
		log.debug("Length before Removal "+updateList.size());
