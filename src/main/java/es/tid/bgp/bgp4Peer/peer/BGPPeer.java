...
public class BGPPeer {
	...
	public void  configure(String nameParametersFile) throws IOException {
		ReaderParamsEnv envfile= new ReaderParamsEnv();
		configure (nameParametersFile, envfile, null,null);
	}
	 ...
	 */
	public void configure(String nameParametersFile, ReaderParamsEnv envfile) throws IOException {
		configure(nameParametersFile, envfile, null, null);
	}
	 ...
	 */
	public void configure(String nameParametersFile, ReaderParamsEnv envfile, MultiDomainTEDB multiTEDB, Hashtable<String,TEDB> iTEDBs) throws IOException {
		//First of all, read the parameters
		if (nameParametersFile != null){
			params=new BGP4Parameters(nameParametersFile, envfile);
		}else{
...
//		}
	...
	{
		//Updater dispatcher
		ud = new UpdateDispatcher(multiDomainTEDB,intraTEDBs, DomainUpdate,intraDomainLinkUpdate,interDomainLinkUpdate,NodeITinfoUpdate, NodeinfoUpdate,MDPCEinfoUpdate,cms_msg,params);
	...
	public void startSendTopology(){
		if (params.isTest()) {
			sendTopologyTask.configure(intraTEDBs, bgp4SessionsInformation, sendTopology, params.getInstanceID(),params.isSendIntradomainLinks(),this.multiDomainTEDB, params.isTest(), params.getMyAutonomousSystem(),"0.0.0.0" ,params.getMyLocalPref());
		}
		else{
			sendTopologyTask.configure(intraTEDBs, bgp4SessionsInformation, sendTopology, params.getInstanceID(),params.isSendIntradomainLinks(),this.multiDomainTEDB, params.getMyAutonomousSystem(),params.getBGPIdentifier(),params.getMyLocalPref());
		}
		...
		cmsPostMsgs.configure(cms_msg, params.BGPIdentifier);
