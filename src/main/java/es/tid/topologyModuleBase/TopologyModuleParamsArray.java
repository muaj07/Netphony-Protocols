...
public class TopologyModuleParamsArray 
{
	...
	public void initialize()
	{
		...
		try
		{
			...
			TopologyModuleParams littleParam = new TopologyModuleParams();
			littleParam.setEnvirFile(getCharacterDataFromElement((Element) doc.getElementsByTagName("EnvironmentFile").item(0)));
			littleParam.setEnv(true);
			paramList.add(littleParam);
