...
public class TopologyModuleParams 
{
	...
	//--- MdO/TADS Identifer Read from the Environment file defined in TM.xml ---//
	private String mdOIdentifier= null;

	//---Domain ID Read from the Environment File defined in TM.xml file
	...
	public String getEnvirFile()
	{
		return envirfile;
	}
	public void setEnvirFile(String EnvirFile)
	{
		envirfile = EnvirFile;
	}
	...
	public void setMdOIdentifier(String mdOIdentifier) {
		this.mdOIdentifier = mdOIdentifier;
	}

	public String getMdOIdentifier() {
		return mdOIdentifier;
	}
