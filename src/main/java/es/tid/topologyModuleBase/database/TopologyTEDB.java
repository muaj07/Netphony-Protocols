...
public interface TopologyTEDB 
{
	...
	void initializeFromFile(String networkDescriptionFile, String file, boolean b, ReaderParamsEnv envfile);

	void initializeFromFile(String file);

	void initializeFromFile(String file, String ID, Boolean test, ReaderParamsEnv envfile);
