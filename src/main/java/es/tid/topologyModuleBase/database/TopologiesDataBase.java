...
public class TopologiesDataBase implements TopologyTEDB
{
	...
	@Override
	public void initializeFromFile(String networkDescriptionFile, String file, boolean b) {
	...
	@Override
	public void initializeFromFile(String file, String ID, boolean test, ReaderParamsEnv envfile) {

		//ted.initializeFromFile(file);
		//System.out.println("It works!!!!");
		teds.putAll(FileTEDBUpdater.readMultipleDomainSimpleNetworks(file, null, false,0,Integer.MAX_VALUE, false, ID, envfile));
